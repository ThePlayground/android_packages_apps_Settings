...
public class BootReceiver extends BroadcastReceiver {
    ...
    private void configureKSM(Context ctx) {
        ...
        String ksmPages = prefs.getString(MemoryManagement.KSM_PAGES_PREF, Utils.fileReadOneLine(MemoryManagement.KSM_PAGES_FILE));
        String ksmSleep = prefs.getString(MemoryManagement.KSM_SLEEP_PREF, Utils.fileReadOneLine(MemoryManagement.KSM_SLEEP_FILE));

        Utils.fileWriteOneLine(MemoryManagement.KSM_RUN_FILE, ksm ? "1" : "0");
        Utils.fileWriteOneLine(MemoryManagement.KSM_PAGES_FILE, ksmPages);
        Utils.fileWriteOneLine(MemoryManagement.KSM_SLEEP_FILE, ksmSleep);
