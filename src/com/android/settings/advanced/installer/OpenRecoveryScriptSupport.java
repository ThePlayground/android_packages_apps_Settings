...
package com.android.settings.advanced.installer;
...
public class OpenRecoveryScriptSupport extends SettingsPreferenceFragment {
    ...
    private static final String TAG = "Settings : ORScriptSupport";
    ...
    private static final String RECOVERY_PATH = SDCARD+ "/LoungeCat/";
    ...
    private static final String BUILD_JSON_PARSER = com.android.settings.advanced.installer.GooImSupport.BUILD_JSON_PARSER;
    private static final String JSON_PARSER = com.android.settings.advanced.installer.GooImSupport.JSON_PARSER;
    ...
    @Override
    public void onCreate(Bundle advanced) {
        super.onCreate(advanced);
        mContext = getActivity().getApplicationContext();
        
        File makeDirs = new File(RECOVERY_PATH);
    ...
    private class WriteScript extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            if (backup_) {
                ...
                script.append(" " + RECOVERY_PATH + LINE_RETURN);
            }
    ...
    private class CheckMD5vsGooIm extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... urls) {
            ...
            try {
                ...
                HttpGet devFolderJSON = new HttpGet(BUILD_JSON_PARSER);
