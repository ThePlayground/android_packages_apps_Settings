...
public class BackupRestore extends SettingsPreferenceFragment {
    ...
    private static String CONFIG_CHECK_PASS = SDCARD + "/LoungeCat/BackRestore/%s has been created";
    private static final String PATH_TO_CONFIGS = SDCARD + "/LoungeCat/BackRestore";
    private static final String PATH_TO_THEMES = SDCARD + "/LoungeCat/BackRestore/themes";
        ...
        final Runnable mRestoreThread = new Runnable() {
            public void run() {
                try {
                    ...
                    final String theme_filename_strings = String.format("%s/LoungeCat/BackupRestore/themes/%s",
            ...
            case THEME_INFO_DIALOG:
                ...
                getInfo.setPositiveButton(getString(R.string.positive_button), new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        String formatThemePath = String.format("%s/LoungeCat/BackupRestore/themes/%s",
